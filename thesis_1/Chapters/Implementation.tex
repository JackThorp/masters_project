...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{Figures/GoopArch}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{Figures/SCArch}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/UserRegistry}}
\decoRule
...
\code{getCoops()} returns the state variable array of CoopContract addresses. \\
 \begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/CoopRegistry}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/MemRegVars}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/CoopState}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/ProposalStructs}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=0.5\textwidth]{Figures/AppStructure}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/dbClassDiagram}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/UserRegistryReactor}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/ReactorsClassDiagram}}
\decoRule
...
\begin{figure}
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Figures/UsersDepRegistration}}
\decoRule
